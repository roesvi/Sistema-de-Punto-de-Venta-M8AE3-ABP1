...
export const useAppStore = defineStore('app', {
  state: () => ({
    ...
    // UI State
    isLoading: false,
    isSidebarOpen: true, // Add sidebar state
    notifications: [],
  ...
  actions: {
    ...
    addNotification(notification) {
      ...
      // Auto-remove notification after specified timeout or default 5 seconds
    ...
    initializeApp() {
      ...
      // Load sidebar preference if needed
      // const savedSidebarState = localStorage.getItem('sidebarOpen');
      // if (savedSidebarState !== null) {
      //   this.isSidebarOpen = savedSidebarState === 'true';
      // }
      
      // Load other initial app data here
